...
void merge_sort_looping(double *array, int start, int end)
{
    ...
    double *temp = (double *)malloc(sizeof(double) * (end - start + 1)); //  save the values after sorting
...
double *start_merge(double *array, size_t array_length)
{
    double *array_merge = common_merge::deep_copy(array, 0, array_length);
