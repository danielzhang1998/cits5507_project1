...
#include <sys/time.h>
#include <time.h>
#include "enum_omp.cpp"
#include "merge_omp.cpp"
#include "quick_omp.cpp"
...
int main(int argc, char *argv[])
{
    ...
    double *array = common_main::generate_array(array_length);
    ...
    else if (argc == 3)
    {
        ...
        common_main::compare_result(array_quick, array_enum, array_merge, array_length);
        free(array_quick);
        free(array_enum);
        free(array_merge);
    }
    ...
    if (argc == 4)
    {
        ...
        {
            //common_main::print_array(array, array_length);
        ...
        else
        {
            ...
            printf("\n");
            common_main::compare_result(omp_quick_result, omp_merge_result, omp_enum_result, array_length);
